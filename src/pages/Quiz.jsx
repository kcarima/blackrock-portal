  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <button onClick={() => navigate('/academy')} className="text-gray-500 mb-6 flex items-center gap-1"><ChevronLeft size={20}/> Volver</button>
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          {!showResult ? (
            ...
            <div className="text-center py-8">
              ...
              <button onClick={() => navigate('/')} className="bg-yellow-500 text-gray-900 font-bold px-8 py-3 rounded-md">Ir al Inicio</button>
            </div>
          )}
        </div>
      </div>
