...
export const Footer = ({ company }) => (
  <footer className="bg-gray-900 text-white py-16 border-t border-gray-800 mt-auto">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 mb-12">
        <div>
          <img src={company.logo} alt="BlackRock Logo" className="h-20 w-auto object-contain mb-6" />
          <p className="text-sm text-white leading-relaxed pr-4">{company.about}</p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className="text-sm text-white mb-6">Síguenos para conocer nuestros últimos proyectos y cursos disponibles.</p>
      ...
      <div className="border-t border-gray-800 pt-8 text-center text-sm text-gray-200">
